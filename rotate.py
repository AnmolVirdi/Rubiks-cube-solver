        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[8]
                    centroid2 = b_colors[2]
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[2]
                    centroid2 = b_colors[8]
                    point1 = (centroid1[5]+(centroid1[7]/2), centroid1[6]+(centroid1[7]/2))
                    point2 = (centroid2[5]+(centroid2[8]/2), centroid2[6]+(centroid2[8]/2))
                    cv2.arrowedLine(bgr_image_input, point1, point2, (0, 0, 0), 7, tipLength = 0.2)
                    cv2.arrowedLine(bgr_image_input, point1, point2, (0, 0, 255), 4, tipLength=0.2)
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[0]
                    centroid2 = b_colors[6]
                    point1 = (centroid1[5]+(centroid1[7]/2), centroid1[6]+(centroid1[7]/2))
                    point2 = (centroid2[5]+(centroid2[8]/2), centroid2[6]+(centroid2[8]/2))
                    cv2.arrowedLine(bgr_image_input, point1, point2, (0, 0, 0), 7, tipLength = 0.2)
                    cv2.arrowedLine(bgr_image_input, point1, point2, (0, 0, 255), 4, tipLength=0.2)
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[6]
                    centroid2 = b_colors[0]
                    point1 = (centroid1[5]+(centroid1[7]/2), centroid1[6]+(centroid1[7]/2))
                    point2 = (centroid2[5]+(centroid2[8]/2), centroid2[6]+(centroid2[8]/2))
                    cv2.arrowedLine(bgr_image_input, point1, point2, (0, 0, 0), 7, tipLength = 0.2)
                    cv2.arrowedLine(bgr_image_input, point1, point2, (0, 0, 255), 4, tipLength=0.2)
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[8]
                    centroid2 = b_colors[6]
                    centroid3 = b_colors[0]
                    centroid4 = b_colors[2]
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[2]
                    centroid2 = b_colors[0]
                    centroid3 = b_colors[6]
                    centroid4 = b_colors[8]
                    point1 = (centroid1[5] + (centroid1[7] / 4), centroid1[6] + (centroid1[7] / 2))
                    point2 = (centroid2[5] + (3 * centroid2[8]/4), centroid2[6] + (centroid2[8] / 2))
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[8]
                    centroid2 = b_colors[6]
                    centroid3 = b_colors[5]
                    centroid4 = b_colors[3]
                    centroid5 = b_colors[2]
                    centroid6 = b_colors[0]
                    point1 = (centroid1[5] + (centroid1[7] / 2), centroid1[6] + (centroid1[7] / 2))
                    point2 = (centroid2[5] + (centroid2[8] / 2), centroid2[6] + (centroid2[8] / 2))
        ...
        if len(face) == 9:
            ...
            if len(faces) == 10:
                ...
                if np.array_equal(detected_face, front_face) == True:
                    ...
                    centroid1 = b_colors[6]
                    centroid2 = b_colors[8]
                    centroid3 = b_colors[3]
                    centroid4 = b_colors[5]
                    centroid5 = b_colors[0]
                    centroid6 = b_colors[2]
                    point1 = (centroid1[5] + (centroid1[7] / 2), centroid1[6] + (centroid1[7] / 2))
                    point2 = (centroid2[5] + (centroid2[8] / 2), centroid2[6] + (centroid2[8] / 2))
                    point3 = (centroid3[5] + (centroid3[7] / 2), centroid3[6] + (centroid3[7] / 2))
                    point4 = (centroid4[5] + (centroid4[8] / 2), centroid4[6] + (centroid4[8] / 2))
